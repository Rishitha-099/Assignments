...
class CurrentAccount extends savings_current_account {
...
class SavingsAccount extends savings_current_account {
...
public class savings_current_account {

	static ArrayList<Integer> totalCashInBank;
    private String name;
    protected int totalDeposits=0;
    public savings_current_account(String name) {
        this.name = name;
    }
    ...
    public static void main(String[] args) {
        ...
        savings_current_account acc1 = new SavingsAccount("acc1");
        savings_current_account acc2 = new CurrentAccount("acc2");
